...
- people who enjoy challanges
- people with more free time
- Enjoys of action RPG's
- people who are nostalgic of older graphics
...
### Assessment: 
- Must have - Multiplayer or co-op
- Nice to have - stylized graphics
- Nice to have - timing mechanics

### Representative quotes:
- "I like fast challenging games where you have to have certain mechanics to do well"
- "When you hit the perfecting timing in the game it just 'feels' good"
- "Hades just had a interesting way of changing up the the dialogue in games and finding out about his past was cool"
...
Plays games in waves, either plays a lot one day or not at all. Is short on free time.
...
### Assessment:
Must have - fast spaced
Must have - skilled based
Nice to have - stylized graphics
Nice to have - polished game
Don't Care - Multiplayer 

### Representative quotes:
- "If I had a lot more time I would oplay multiplayer games more"
- "A lot of games aren't as polished as you would expect for $60"
- "Something I don't like about dungeon crawelers is that they can feel very simple"
...
### Assessment: 
Must have - competitive multiplayer
Must have - Movement options
Nice to have - Realistic graphics
Don't Care - 2d or pixel graphics 

### Representative quotes:
- "If a game doesn't require your attention it's not worth playing"
- "Being able to 'cheat' the game is fun, like taking advantage of spawn points"
- "I really like winning so I found myself liking competitive games"
...
- Must have: Multiplayer or co-op
- Nice to have:  Stylized graphics
- Don't Care: dungeon crawler games

### Representative quotes:
- "Contra was cool becuase there was nothing else like that at the time"
- "I never really had a lot of free time and I liked video games so when I had the time I wanted to hangout and play video games"
- "I my son isn't there I won't even play the Xbox"
...
Enjoys playing with other people and enjoys having close social/chat tie ins in multiplayer games.
...
- Nice to have:  Playing with other people  
- Don't Care: retro style games
...
### Assessment: 
- Must have: PC platform  
- Nice to have:  Well done pixel art
...
about the resources, such as ammunition, they have at their disposal
   - "I really like how Dead Space made me think about using my weapons. I could unload a magazine into an alien, but what
     happens if I need ammo later down the line and I don't have."
...
can be done in many ways, and tricks, even as simple as jumping, can be employed to take out enemies in unique ways
   - "The thing that really annoys about traversal mechanics is when they are not scaled with the size of the world. Fallout
     New Vegas has a big map, but the player just lightly jogs across the map."
...
Example: Call of Duty Zombies rewards the player the same 25 points for defeating a basic zombie and a juggernaught zombie
   - "The juggernaught zombies in Call of Duty Vanguard Zombies are just annoying because they take a lot to kill, but you
     don't get anything for doing so."
...
Must Have:
   - Scaled movement/traversal mechanics

   - Upgrade systems that allow the player to take on more difficult challenges

Nice To Have:
   - Resource management for the player

Don't Care:
   - Difficult enemies that don't challenge the player to evolve their approach
...
Interviewee: Ender / 20 / Studying Media  
Interviewer: Asa Henry  
...
First Person games help become the character and experience the game as a person
   - "It's easier to get invested if I can be the character."

Third Persons have to have an "established character"; third person games have to give value to watching a character
   - "If I can watch the character and get invested in what they are doing, I will playe third person."

Believes that every art style has a place, but the art must fit into the game -
   - "My favorite art style is that 'oil paint' look; for example, every scene in Dishonored looks as if it were painted by
     another person."
...
Does not like when games have mechanics just to have mechanics
   - "I could not get into Goat Simulator because it just had stuff for the sake of stuff; there was no realy value in
     the mechanics."
...
Wishes to see more games that work to create connections between the player and the NPCs -
   - "When Thane died in Mass Effect 3, I saluted my screen. That character is with the player for most of the triology,
     and then they just kill him."

### Assessment:

Must Have:
   - Some way for the player to be creative
...
Nice To Have:
   ...
   - Make the environment part of the story
...
-----------------------------------------------------------------------------------------------------------------------
## Initial Consumer Segments:
- people who enjoy random elements
- people who can take the game at their own pace
- people who play with friends online or local co-op
- people who run older graphics because their PC is slow

## Final Value Proposition
Hop in and out on fast paced adventures with your friends, or take on the task alone.
